export const PROFILE = {
  ...
  phone: "+82 10-3996-8849",
  contact: {
    ko: {
      title: "Contact me",
      description:
        "궁금한 점이 있거나 그냥 인사하고 싶다면, 부담 없이 메시지 보내주세요!",
    },
    en: {
      title: "Let’s connect",
      description:
    ...
    ar: {
      title: "لنتواصل",
      description:
        "إذا أردت قول مرحباً أو لديك أي سؤال، لا تتردد في إرسال رسالة!",
    },
  },
  titles: {
...
إذا كانت لديك فكرة ممتعة، فلنصنعها معاً!`,
  ...
  statusMessages: {
    ...
    en: [
      "studying AI",
      "somewhere between React and Flutter",
      "exploring the frontend galaxy",
      "thinking about camping again",
    ...
    ar: [
      ...
      "في مكان ما بين React وFlutter",
      "أستكشف مجرة الواجهة الأمامية",
      "أفكر في التخييم مجددًا",
      "أحفظ حياتي الجامعية مؤقتًا",
      "أفكر في مشروع جانبي جديد",
    ],
  },
};
